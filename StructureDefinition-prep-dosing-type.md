# PrEPDosingType - Ethiopia HIV IG (sandbox demo subset) v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.et/hiv/StructureDefinition/prep-dosing-type | *Version*:0.1.0 |
| Draft as of 2026-06-17 | *Computable Name*:PrEPDosingType |

**Usages:**

* This Profile is not used by any profiles in this Specification

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.hiv|current/StructureDefinition/StructureDefinition-prep-dosing-type.json)
...
```json
{
  ...
  "id" : "prep-dosing-type",
  "url" : "http://fhir.et/hiv/StructureDefinition/prep-dosing-type",
  "version" : "0.1.0",
  "name" : "PrEPDosingType",
  "status" : "draft",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://fhir.et/hiv/ValueSet/prep-dosing-type-vs"
      }
    },
    {
