# Prevention Services Offered and Referrals - Ethiopia HIV IG (sandbox demo subset) v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.et/hiv/StructureDefinition/hiv-prevention-services | *Version*:0.1.0 |
| Draft as of 2026-06-17 | *Computable Name*:HIVPreventionServicesObservation |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/et.fhir.hiv|current/StructureDefinition/StructureDefinition-hiv-prevention-services.json)
...
```json
{
  ...
  "url" : "http://fhir.et/hiv/StructureDefinition/hiv-prevention-services",
  "version" : "0.1.0",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "http://fhir.et/hiv/ValueSet/hiv-prevention-services-vs"
      }
    }]
  }
}
